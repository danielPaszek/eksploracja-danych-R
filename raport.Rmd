...
plot(corr)
```
Zależność pomiędzy Average Voltage i Gravimetric Energy jest gorzej widoczna przez obecność wartości skrajnych na wykresie. Po usunięciu outlierów widzimy 
```{r cor2}
